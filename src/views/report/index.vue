<template>
  <div class="reportBox">
    <div class="mediaAndReportWrapper">
      ...
      <div class="list">
        <a class="listItem" :href="item.article_url" target="_blank" v-for="item in reportList" :key="item.id">
      ...
      <div class="nextPage" @Click="nextPageReport">加载更多</div>

      <!-- <div class="mediaAndReportLinkWrapper">
        <Link class="mediaAndReportLink" to="/report">{'更多>>>'}</Link>
      </div> -->
    </div>
  </div>
</template>
