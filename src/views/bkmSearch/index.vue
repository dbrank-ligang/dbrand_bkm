...
const tradeArrSelected = ref(["汽车", "美妆个护", "运动装备"]); // 行业选中的数组
const brandArrSelected = ref(["阿里巴巴", "海尔"]); // 品牌选中的数组
const typesArrSelected = ref(["阿里巴巴", "海尔"]); // 类型选中的数组
